...
$user = $_SESSION['user_name'];
		...
		$sender  = $_POST['recipient'];
		$message    = stripslashes(htmlspecialchars($_POST['message']));
		
		
	if ($sender =='') {echo 'id failed, refresh the pagez!'; die();}
	
		$currentserverdate = strtotime("now");
		$execsql = mysqli_query($link,"INSERT INTO messages (`sender`, `receiver`,`message`, `seen_flag`, `time`) VALUES ('$user','$sender', '$message','0', $currentserverdate)" ) or die('<div class="btn">Special characters are not allowed like back quote!</div>');
...
<div class="scroll-mail email-list">
                    ...
                    <div class="content messages npb">  <div class="scroll" style="height: 200px;"> 
<?php
